...
fun VerticalSplittable(
    modifier: Modifier, splitterState: SplitterState, onResize: (delta: Dp) -> Unit, children: @Composable () -> Unit
) = Layout({
    children()
...
fun VerticalSplitter(
    splitterState: SplitterState, onResize: (delta: Dp) -> Unit, color: Color = Color.DarkGray
) = Box {
    ...
    Box(
        Modifier.width(1.dp).fillMaxHeight().background(color)
    )
}